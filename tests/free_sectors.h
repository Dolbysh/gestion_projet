...
//static free_sector *mem_SSD = NULL;
...
uint64_t get_line();
void free_one_line();
free_sector * init_free_sector(uint64_t size, uint64_t occup_max, uint64_t occup_min, uint64_t first_line, uint64_t last_usable);
